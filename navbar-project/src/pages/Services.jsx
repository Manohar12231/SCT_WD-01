...
const Services = () => (
  <PageWrapper title="Our Craft">
    ...
    >
      <h1 className="text-4xl md:text-5xl font-bold mb-4">What We Build</h1>
      <p className="lead text-xl max-w-3xl mx-auto text-gray-600 dark:text-gray-400">
        We craft beautiful, high-performance web experiences that solve business problems and delight users. Our work is a blend of artistry, engineering, and a relentless pursuit of quality.
      </p>
    </motion.div>
